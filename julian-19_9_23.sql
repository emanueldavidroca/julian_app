...
-- Dumping data for table julian_app.products: ~5 rows (approximately)
REPLACE INTO `products` (`id`, `productName`, `description`, `barCode`, `idCategoria`, `price`, `img`, `stock`, `createdAt`, `deletedAt`, `updatedAt`, `status`) VALUES
...
REPLACE INTO `users` (`id`, `usuario`, `password`, `email`, `createdAt`, `deletedAt`, `updatedAt`, `rol`) VALUES
	...
	(2, 'ema', '123asd', 'ema@gmail.com', '2023-09-18 17:15:47', NULL, NULL, 'cliente');
