...
DROP DATABASE IF EXISTS `julian_app`;
...
-- Dumping data for table julian_app.users: ~1 rows (approximately)
REPLACE INTO `users` (`id`, `usuario`, `password`, `email`) VALUES
	(1, 'julian', '123asd', 'julian@gmail.com');
